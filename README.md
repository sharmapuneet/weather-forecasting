...
This component is the third section of sidebar. It includes the ramp chart which consumes data from the context and create a Doughnut chart using chartJs library.dss
